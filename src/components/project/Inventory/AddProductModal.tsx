...
export default function AddProductModal() {
  ...
  useEffect(() => {
    const getCategories = async () => {
      ...
      setSub_category(response.data[0]?.sub_categories[0]._id);
                          ...
                          <div className="w-full flex flex-col justify-between gap-4">
                            {categories.length >= 1 ? (
                              ...
                              <div className="text-sm">
                                <h3>
                                  Aún no tenes categorías creadas, creala antes
                                  de registrar un producto!
                                </h3>
                              </div>
                            )}
                            <button
