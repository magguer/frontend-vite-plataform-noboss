...
function Summary() {
  ...
  return (
    <div className="fade-in-left h-[calc(100dvh-175px)] tablet:h-[calc(100dvh-205px)] overflow-auto scrollbar-thin scrollbar-thumb-lightbgsecondary dark:scrollbar-thumb-darkbgsecondary scrollbar-track-lightbgprimary dark:scrollbar-track-darkbgprimary scrollbar-thumb-rounded scrollbar-track-rounded px-1">
