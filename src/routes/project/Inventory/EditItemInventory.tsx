      ...
      <div className="relative">
        {product ? (
          <div className="fade-in-right">
            ...
            >
              {/*          EDIT INFO PRODUCTS */}
              <div className="w-full  laptop:w-auto flex max-h-[90dvh] ">
                <div>
                  <div className="px-2 mb-4 pb-3 max-h-[49dvh] tablet:max-h-[60dvh] laptop:max-h-[55dvh] overflow-auto scrollbar-thin scrollbar-thumb-lightbgsecondary dark:scrollbar-thumb-darkbgsecondary scrollbar-track-lightbgprimary dark:scrollbar-track-darkbgprimary scrollbar-thumb-rounded scrollbar-track-rounded ">
                    <div className="w-full flex justify-between gap-2">
                      ...
                      <div className="grid gap-1 w-full">
                        <label className="ml-1 text-sm" htmlFor="sku">
                          Sku
                        </label>
                        <input
                          className="text-sm w-full py-2 px-2 border-transparent rounded-lg focus:ring-gray-600 bg-lightbgprimary dark:bg-darkbgprimary focus:border-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500 "
                    ...
                    <div className="w-full flex justify-between pt-2 gap-2">
                      {/*   Select Categories */}
                      <div className="grid gap-1 w-full">
                        <label className="ml-1 text-sm" htmlFor="category">
                          Categoria
                        </label>
                        <select
                          className="text-sm w-full py-2 px-2 border-transparent rounded-lg focus:ring-gray-600 bg-lightbgprimary dark:bg-darkbgprimary focus:border-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500"
                        ...
                        >
                          <option selected value={product.category.slug}>
                      ...
                      <div className="grid gap-1 w-full">
                        <label className="ml-1 text-sm" htmlFor="sub_category">
                          Sub-Categoria
                        </label>
                        <select
                          className="text-sm w-full py-2 px-2 border-transparent rounded-lg focus:ring-gray-600 bg-lightbgprimary dark:bg-darkbgprimary focus:border-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500 "
                    ...
                    <div className="grid gap-1 w-full pt-2">
                      <label className="ml-1 text-sm" htmlFor="description">
                        Descripción
                      </label>
                      <textarea
                    ...
                    <div className="flex justify-center gap-1">
                      <div className="flex gap-2 px-2 py-2 max-h-[34dvh] overflow-auto scrollbar-thin scrollbar-thumb-lightbgsecondary dark:scrollbar-thumb-darkbgsecondary scrollbar-track-lightbgprimary dark:scrollbar-track-darkbgprimary scrollbar-thumb-rounded scrollbar-track-rounded ">
                    ...
                    <div className="w-full flex justify-between pt-2 gap-2">
                      {/*  Price */}
                      <div className="grid gap-1 w-full">
                        <label className="ml-1 text-sm" htmlFor="price">
                          Precio ($)
                        </label>
                        <input
                          className="text-sm w-full py-2 px-2 border-transparent rounded-lg focus:ring-gray-600 bg-lightbgprimary dark:bg-darkbgprimary focus:border-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500 "
                      ...
                      {/*  Cost */}
                      <div className="grid gap-1 w-full">
                        <label className="ml-1 text-sm" htmlFor="cost">
                          Costo ($)
                        </label>
                        <input
                          className="text-sm w-full py-2 px-2 border-transparent rounded-lg focus:ring-gray-600 bg-lightbgprimary dark:bg-darkbgprimary focus:border-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500 "
